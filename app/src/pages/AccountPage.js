...
export default function AccountPage(props) {
    ...
    return (
        ...
        <div id='container' className='flex flex-col lg:flex-row items-center justify-center gap-5 pt-20 font-["Lato"] bg-neutral-200 shadow-md min-h-screen'>



            <div id='account-info-card' className='bg-white rounded-lg p-5'>
            ...
            <div className=''>
                ...
                <div id='account-options-card' className='pb-20 lg:mb-0 rounded-lg bg-white shadow-md p-5'>
