  ...
  return (
    ...
    <div className='overflow-x-hidden w-full'>
      ...
      <div className='xl:h-screen px-10 pb-20 xl:px-40 d-flex flex-column justify-center' id='hero-section'>
        <h1 className='text-light text-5xl xl:text-7xl py-20 font-["Lato"] font-bold leading-snug'>
      ...
      <div className='py-5 px-5 xl:px-40 border bg-neutral-100'>
      ...
      <section className='px-5 xl:px-40 py-20'>
        ...
        <div class="flex flex-row flex-wrap">
          ...
          <div class="col-md-6 col-lg-4 mb-4 bg-blue-200 p-5 rounded-sm">
            <h6 class="mb-5 text-blue-600 text-lg xl:text-3xl">What does the BGC do that’s not currently being done in the industry</h6>
          ...
          <div class="col-md-6 col-lg-4 mb-4 bg-blue-100 p-5 rounded-sm">
            <h6 class="mb-5 text-blue-600 text-lg xl:text-3xl">Why would spine/orthopedic or small biologic companies join the BGC?</h6>
            <p class="text-sm xl:text-lg">
          ...
          <div class="col-md-6 col-lg-4 mb-4 bg-blue-200 p-5 rounded-sm">
            <h6 class="mb-5 text-blue-600 text-lg xl:text-3xl">Who will the BGC consist of and how will it help “level the playing field”?
            </h6>
            <p class="text-sm xl:text-lg">
          ...
          <div class="col-md-6 col-lg-4 mb-4 bg-blue-100 p-5 rounded-sm">
            <h6 class="mb-5 text-blue-600 text-lg xl:text-3xl">A simple
              question?
            </h6>
            <p class="text-sm xl:text-lg">
          ...
          <div class="col-md-6 col-lg-4 mb-4 bg-blue-200 p-5 rounded-sm">
            ...
            <p class="text-sm xl:text-lg"><strong><u>Unfortunately no</u>.</strong> We do not issue full or partial refunds for any
              reason.</p>
          </div>
          ...
          <div class="col-md-6 col-lg-4 mb-4 bg-blue-100 p-5 rounded-sm">
            <h6 class="mb-5 text-blue-600 text-lg xl:text-3xl"> Another
